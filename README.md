...
│   └── sql_tables.sql                      # SQL-схемы для создания таблиц в базе
├── etl
│   ├── prepare_db_and_storage.py           # Этап подготовки бд, схем, таблиц
│   ├── processing_raw_data.py              # Этап предварительной обработки сырых распрарсенных данных
│   ├── transform_raw_data.py               # Этап преобразование сырых данных к требуемому виду
│   └── write_pg_final_tables.py            # Этап записи итоговых таблиц в postgres
├── parsers
...
## Загрузка страниц с результатами в хранилище
