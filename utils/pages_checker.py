...
def check_processed_pages(spark, date_html_pairs, schema_name, postgres_props):
    ...
    processed_pages_df = read_from_postgres(spark, f"{schema_name}.pages_processing_log", postgres_props)
